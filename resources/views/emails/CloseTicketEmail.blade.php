            ...
            <table border="0" cellspacing="0" cellpadding="0" style="color:#0f3462; font-family: sans-serif;">
                ...
                <tr>
                    <td>
                        ...
                        <h2 style=" margin: 0px 40px;padding-bottom: 25px;line-height: 2; font-size: 15px;">Your Support Ticket has been closed</h2>
                        <p style=" margin: 0px 40px;padding-bottom: 25px;line-height: 2; font-size: 15px;">Thank you for contacting our support team.
                        </p>
